...
export const Validate = (value , validators) =>{
    ...
    for( const validator in validators){
       ...
       if(validators[validator].type === VALIDATOR_TYPE_MAXLENGTH){
       ...
       if(validators[validator].type === VALIDATOR_TYPE_MAX){
           isValid = isValid && +value <= validator.val;
       }
   
       if(validators[validator].type === VALIDATOR_TYPE_MIN){
           isValid = isValid && +value >= validator.val;
       }
       ...
       if(validators[validator].type === VALIDATOR_TYPE_FILE){
